import { Plus, MoreHorizontal, AlignLeft } from 'lucide-react';
    ...
    <div className="p-8 h-full flex flex-col overflow-hidden">
      <div className="flex justify-between items-center mb-8 shrink-0">
        <div>
          ...
          <p className="text-text-muted text-sm">Track content production stages.</p>
        </div>
              ...
              <div className="flex-1 overflow-y-auto p-3 space-y-3">
                ...
                <div className="bg-surface border border-border rounded-xl p-4 cursor-grab hover:border-primary/50 transition-colors shadow-sm">
                  ...
                  <div className="flex items-center gap-3 text-xs text-text-muted mt-4">
                    ...
                    <div className="ml-auto w-6 h-6 rounded-full bg-gradient-to-br from-primary to-purple-500"></div>
                  </div>
                </div>
